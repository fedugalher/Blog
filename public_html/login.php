...
<head>
  ...
  <link rel="stylesheet" href="<?php echo $host_dir ?>/css/login.css">
...
<?php require_once('templates/navbar.php') ?>
			...
			<div class="col-lg-12 login-container">
              ...
              <div class="col-lg-4 login-box">
                ...
                <div class="login-links">
                  ...
                  <a href="user_passwordRequest.php">Restablecer Contraseña</a>
                </div>
              </div>
          </div>
				</article>
  ...
  <script src="<?php echo $host_dir ?>/js/login.js"></script>
