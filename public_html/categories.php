...
<head>
  ...
  <link rel="stylesheet" href="<?php echo $host_dir ?>/css/categories.css">
...
<body>
	...
	<script src="<?php echo $host_dir ?>/js/categories.js"></script>
	<script src="<?php echo $host_dir ?>/js/category_new.js"></script>
	<script src="<?php echo $host_dir ?>/js/category_delete.js"></script>
