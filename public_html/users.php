...
<body>
	...
	<script src="<?php echo $host_dir ?>/js/users.js"></script>
	<script src="<?php echo $host_dir ?>/js/user_new.js"></script>
	<script src="<?php echo $host_dir ?>/js/user_edit.js"></script>
	<script src="<?php echo $host_dir ?>/js/user_delete.js"></script>
